...
// DefaultConfig returns the default configuration for NookClaw.
func DefaultConfig() *Config {
	workspacePath := filepath.Join(appenv.DefaultHomeDir(), "workspace")
	...
	return &Config{
		...
		ModelList: []ModelConfig{
			...
			// Personal local default via Ollama.
			// Change the model name if your machine uses a different Ollama model.
			{
				ModelName: "private-local",
