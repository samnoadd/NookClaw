...
func TestResolveWorkspace(t *testing.T) {
	result := ResolveWorkspace("/home/user/.nookclaw")
	assert.Equal(t, "/home/user/.nookclaw/workspace", result)
}

func TestRelPath(t *testing.T) {
	result := RelPath("/home/user/.nookclaw/workspace/file.txt", "/home/user/.nookclaw")
...
func TestResolveTargetHome(t *testing.T) {
	...
	require.NoError(t, err)
	assert.Equal(t, filepath.Join(home, ".nookclaw"), result)
}
