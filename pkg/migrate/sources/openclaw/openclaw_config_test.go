...
func TestLoadOpenClawConfig(t *testing.T) {
	...
	if workspace != "~/.nookclaw/workspace" {
		t.Errorf("expected workspace '~/.nookclaw/workspace', got '%s'", workspace)
	}
...
func TestConvertToPicoClaw(t *testing.T) {
	...
	if picoCfg.Agents.Defaults.Workspace != "~/.nookclaw/workspace" {
		t.Errorf("expected workspace '~/.nookclaw/workspace', got '%s'", picoCfg.Agents.Defaults.Workspace)
	}
...
func TestToStandardConfig_ExecAllowRemoteDefaultsFalse(t *testing.T) {
	...
	if cfg.Tools.Exec.AllowRemote {
		t.Fatal("ToStandardConfig() should preserve the NookClaw default tools.exec.allow_remote=false")
	}
}
...
func TestToStandardConfig(t *testing.T) {
	...
	if stdCfg.Agents.Defaults.Workspace != "~/.nookclaw/workspace" {
		t.Errorf("expected workspace '~/.nookclaw/workspace', got '%s'", stdCfg.Agents.Defaults.Workspace)
	}
