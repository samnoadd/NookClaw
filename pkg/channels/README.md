# NookClaw Channel System: Complete Development Guide

> **Scope**: `pkg/channels/`, `pkg/bus/`, `pkg/media/`, `pkg/identity/`, `cmd/nookclaw/internal/gateway/`
...
├── README.md            # Channel system documentation
...
import (
    "github.com/samnoadd/NookClaw/pkg/bus"
    "github.com/samnoadd/NookClaw/pkg/channels"     // Reference parent package
    "github.com/samnoadd/NookClaw/pkg/config"
    "github.com/samnoadd/NookClaw/pkg/identity"      // New
    "github.com/samnoadd/NookClaw/pkg/media"          // New (if media support needed)
)
```
...
```go
// cmd/nookclaw/internal/gateway/helpers.go
import (
    _ "github.com/samnoadd/NookClaw/pkg/channels/telegram"   // Triggers init() registration
    _ "github.com/samnoadd/NookClaw/pkg/channels/discord"
    _ "github.com/samnoadd/NookClaw/pkg/channels/your_new_channel"  // New addition
)
```
...
import (
    ...
    "github.com/samnoadd/NookClaw/pkg/channels"
    "github.com/samnoadd/NookClaw/pkg/config"
    "github.com/samnoadd/NookClaw/pkg/identity"
...
4. **Pico Protocol**: `pkg/channels/pico/` implements a custom NookClaw native protocol channel that receives messages via WebSocket webhook (`/pico/ws`).
