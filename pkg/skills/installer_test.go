...
func TestParseGitHubRef(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			repo:         "samnoadd/NookClaw",
			wantOwner:    "samnoadd",
			wantRepoName: "NookClaw",
			wantRef:      "main",
			wantSubPath:  "",
		},
		{
			name:         "owner/repo with subpath",
			repo:         "samnoadd/NookClaw/skills/test",
			wantOwner:    "samnoadd",
			wantRepoName: "NookClaw",
			wantRef:      "main",
		...
		},
		{
			...
			repo:         "https://github.com/samnoadd/NookClaw/tree/dev/skills/test",
			wantOwner:    "samnoadd",
			wantRepoName: "NookClaw",
			wantRef:      "dev",
			wantSubPath:  "skills/test",
		},
		{
			...
			repo:         "https://github.com/samnoadd/NookClaw/blob/main/README.md",
			wantOwner:    "samnoadd",
			wantRepoName: "NookClaw",
			wantRef:      "main",
		...
		},
		{
			...
			repo:         "https://github.com/samnoadd/NookClaw",
			wantOwner:    "samnoadd",
			wantRepoName: "NookClaw",
			wantRef:      "main",
			wantSubPath:  "",
		...
		},
		{
			...
			repo:           "https://github.com/samnoadd",
			wantErr:        true,
...
func TestSkillInstaller_InstallFromGitHub_SkillAlreadyExists(t *testing.T) {
	...
	existingSkill := filepath.Join(skillsDir, "NookClaw")
	...
	err = installer.InstallFromGitHub(context.Background(), "samnoadd/NookClaw")
	if err == nil {
