...
import (
	...
	anthropicmessages "github.com/samnoadd/NookClaw/pkg/providers/anthropic_messages"
	"github.com/samnoadd/NookClaw/pkg/providers/azure"
)
...
func createClaudeAuthProvider() (LLMProvider, error) {
	...
	if cred == nil {
		return nil, fmt.Errorf("no credentials for anthropic. Run: nookclaw auth login --provider anthropic")
	}
...
func createCodexAuthProvider() (LLMProvider, error) {
	...
	if cred == nil {
		return nil, fmt.Errorf("no credentials for openai. Run: nookclaw auth login --provider openai")
	}
