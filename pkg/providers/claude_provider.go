...
import (
	...
	anthropicprovider "github.com/samnoadd/NookClaw/pkg/providers/anthropic"
)
...
func createClaudeTokenSource() func() (string, error) {
	return func() (string, error) {
		...
		if cred == nil {
			return "", fmt.Errorf("no credentials for anthropic. Run: nookclaw auth login --provider anthropic")
		}
