	...
	tests := []struct {
		...
		},
		{
			...
			setup: func(cfg *config.Config) {
				...
				cfg.Agents.Defaults.ModelName = "deepseek/deepseek-chat"
		...
		},
		{
			...
			setup: func(cfg *config.Config) {
				cfg.Agents.Defaults.ModelName = "openrouter/auto"
		...
		},
		{
			...
			setup: func(cfg *config.Config) {
				cfg.Agents.Defaults.ModelName = "groq/llama-3.3-70b"
		...
		},
		{
			...
			setup: func(cfg *config.Config) {
				cfg.Agents.Defaults.ModelName = "ollama/qwen2.5:14b"
		...
		},
		{
			...
			setup: func(cfg *config.Config) {
				cfg.Agents.Defaults.ModelName = "moonshot/kimi-k2.5"
		...
		},
		{
			...
			setup: func(cfg *config.Config) {
				cfg.Agents.Defaults.ModelName = "longcat/LongCat-Flash-Thinking"
				cfg.Providers.LongCat.APIKey = "longcat-key"
			},
			wantType:    providerTypeHTTPCompat,
			wantAPIBase: "https://api.longcat.chat/openai",
		},
		{
			...
			setup: func(cfg *config.Config) {
				cfg.Agents.Defaults.ModelName = "custom-model"
			},
