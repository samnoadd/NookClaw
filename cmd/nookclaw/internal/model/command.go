...
Examples:
  nookclaw model                    # Show current default model
  nookclaw model gpt-5.2           # Set gpt-5.2 as default
  nookclaw model claude-sonnet-4.6 # Set claude-sonnet-4.6 as default
  nookclaw model local-model       # Set local VLLM server as default
